...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Impl.Reports.Hoplites
{
    /// <summary>
    /// Todo
    /// </summary>
    public struct HopliteReportImpl
        : IHopliteReport
    {
        // Todo
        ...
        private HopliteReportImpl(ControllerIdEnum controllerId, IHopliteAttributes hopliteAttributes)
        {
        ...
        public class Builder
        {
            ...
            public IHopliteReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new HopliteReportImpl(this.controllerId, this.hopliteAttributes);
                }
                else
                {
