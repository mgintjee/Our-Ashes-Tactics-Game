/*using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.AIs.Types;
...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Controllers.AIs.Inters;
...
namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Controllers.Impls
{
    /// <summary>
