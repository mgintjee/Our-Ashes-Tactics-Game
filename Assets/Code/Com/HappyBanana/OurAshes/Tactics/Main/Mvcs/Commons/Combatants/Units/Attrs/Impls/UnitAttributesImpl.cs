...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Combatants.Units.Attrs.Impls
{
    /// <summary>
        ...
        : IUnitAttributes
    {
        ...
        public class Builder
        {
                ...
                : IBuilder<IUnitAttributes>
            {
                ...
                IUnitAttributes Build(IList<IUnitAttributes> attributes);
            }
                ...
                : AbstractBuilder<IUnitAttributes>, IInternalBuilder
            {
                ...
                /// <inheritdoc/>
                IUnitAttributes IInternalBuilder.Build(IList<IUnitAttributes> attributes)
                {
                    IList<IMovableAttributes> movableAttributes = new List<IMovableAttributes>();
                    IList<IDestructibleAttributes> destructibleAttributes = new List<IDestructibleAttributes>();
                    IList<IFireableAttributes> fireableAttributes = new List<IFireableAttributes>();
