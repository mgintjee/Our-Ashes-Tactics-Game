...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Impl.Objects.Paths.Objects.Move
{
    /// <summary>
    /// Todo
    /// </summary>
    ...
    : PathObjectAbstract
    {
        ...
        /// </param>
        public PathObjectMoveImpl(List<ICubeCoordinates> tileObjectStepList)
