...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Combatants.Loadouts.Engines.Gears.Details.Impls
{
    /// <summary>
        ...
        : IEngineGearDetails
    {
        ...
        /// <inheritdoc/>
        EngineGearID IEngineGearDetails.GetGearID()
        {
