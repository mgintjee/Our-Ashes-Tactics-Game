...
namespace HappyBananaStudio.OurAshesTactics.Common.Utils.Finders
{
    ...
    public class FinderUtil
    {
        ...
        /// <returns>
        /// </returns>
        public static ISet<GameObject> FindAllGameObjectType(System.Type type)
        {
        ...
        {
            logger.Debug("Finding Type: Name=?", type.Name);
            ISet<GameObject> foundGameObjectSet = Find(type);
            if (foundGameObjectSet.Count > 0)
            {
                ...
                IList<GameObject> foundGameObjectList = new List<GameObject>(foundGameObjectSet);
        ...
        /// <returns>
        /// </returns>
        private static ISet<GameObject> Find(System.Type type)
        {
            // Default a null found GameObject
            ISet<GameObject> foundGameObjectSet = new HashSet<GameObject>();
