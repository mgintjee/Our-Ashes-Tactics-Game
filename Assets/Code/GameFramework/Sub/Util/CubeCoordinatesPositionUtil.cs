...
public static class CubeCoordinatesPositionUtil
{
    ...
    // Todo
    private static readonly float PositionOffsetX = TileGameObjectConstants.GetOffsetX();

    // Todo
    private static readonly float PositionOffsetY = TileGameObjectConstants.GetOffsetY();

    // Todo
    private static readonly float PositionOffsetZ = TileGameObjectConstants.GetOffsetZ();
