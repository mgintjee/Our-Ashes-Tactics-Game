namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Loadouts.Reports.Impl
{
    ...
    /// Todo
    /// </summary>
    public struct TalonLoadoutReportImpl
        : ITalonLoadoutReport
    {
        // Todo
        ...
        private TalonLoadoutReportImpl(TalonId talonId, IArmorReport armorReport, IEngineReport engineReport, IList<IMountReport> mountReportList)
        {
        ...
        public class Builder
        {
            ...
            public ITalonLoadoutReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonLoadoutReportImpl(this.talonId, this.armorReport, this.engineReport, this.mountReportList);
                }
                else
                {
