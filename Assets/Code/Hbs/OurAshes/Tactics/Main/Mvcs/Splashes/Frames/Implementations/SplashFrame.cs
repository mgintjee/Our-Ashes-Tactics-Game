...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Controllers.Splashes.Implementations;
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Frames.Interfaces;
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Models.Implementations;
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Views.Implementations;

namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Frames.Implementations
{
    /// <summary>
