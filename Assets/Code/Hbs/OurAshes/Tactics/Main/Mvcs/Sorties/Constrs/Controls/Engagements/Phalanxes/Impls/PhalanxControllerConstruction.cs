...
namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Constrs.Controls.Engagements.Phalanxes.Impls
{
    /// <summary>
    /// Todo
    /// </summary>
    public struct PhalanxControlConstruction : IPhalanxControlConstruction
    {
        ...
        /// <inheritdoc/>
        ControlID IPhalanxControlConstruction.GetControlType()
        {
            return _ControlID;
        }
