...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Mvc.Models
{
    /// <summary>
    /// Todo
    /// </summary>
    public struct MvcModelInformationReport
        : IMvcModelInformationReport
    {
        ...
        /// </param>
        private MvcModelInformationReport(IGameMapInformationReport gameMapInformationReport, IRosterInformationReport rosterInformationReport)
        {
        ...
        public class Builder
        {
            ...
            public IMvcModelInformationReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new MvcModelInformationReport(this.gameMapInformationReport, this.rosterInformationReport);
                }
                else
                {
