...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Paint
{
    /// <summary>
    /// Todo
    /// </summary>
    public struct PaintSchemeReport
        : IPaintSchemeReport
    {
        // Todo
        ...
        /// </param>
        private PaintSchemeReport(PaintColorIdEnum primaryPaintColorId,
        ...
        public class Builder
        {
            ...
            public IPaintSchemeReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new PaintSchemeReport(this.primaryPaintColorId, this.secondaryPaintColorId, this.tertiaryPaintColorId);
                }
                else
                {
