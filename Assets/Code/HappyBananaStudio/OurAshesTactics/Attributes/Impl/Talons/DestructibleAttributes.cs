...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Attributes.Impl.Talons
{
        ...
        : IDestructibleAttributes
    {
        ...
        /// </param>
        private DestructibleAttributes(int armorPoints, int healthPoints)
        {
        ...
        /// </param>
        private DestructibleAttributes(ICollection<IDestructibleAttributes> destructibleAttributeCollection)
        {
            int armorPoints = 0;
            int healthPoints = 0;
        ...
        public class Builder
        {
            ...
            public IDestructibleAttributes Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    if (this.destructibleAttributesCollection != null)
                    {
                        ...
                        return new DestructibleAttributes(this.destructibleAttributesCollection);
                    }
                    else
                    {
                        // Instantiate a new Report
                        return new DestructibleAttributes(this.armorPoints, this.healthPoints);
                    }
                }
                else
                {
            ...
            private HashSet<string> IsInvalid()
            {
                ...
                if (this.destructibleAttributesCollection == null)
                {
                    ...
                    {
                        argumentExceptionSet.Add("Collection: " + typeof(IDestructibleAttributes).Name + " has not been set");
                    }
                }
                else
                {
