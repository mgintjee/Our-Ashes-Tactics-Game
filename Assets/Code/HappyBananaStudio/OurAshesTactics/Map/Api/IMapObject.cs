...
namespace HappyBananaStudio.OurAshesTactics.Mvc.Model.Sub.Map.Api
{
    ...
    public interface IMapObject
    {
        ...
        /// <returns></returns>
        int GetHexTileObjectFireCostFrom(CubeCoordinates cubeCoordinates);
        ...
        /// <param name="cubeCoordinates"></param>
        /// <returns></returns>
        IHexTileObject GetHexTileObjectFrom(CubeCoordinates cubeCoordinates);
        ...
        /// <param name="cubeCoordinates"></param>
        /// <returns></returns>
        HashSet<CubeCoordinates> GetNeighborCubeCoordinates(CubeCoordinates cubeCoordinates);
