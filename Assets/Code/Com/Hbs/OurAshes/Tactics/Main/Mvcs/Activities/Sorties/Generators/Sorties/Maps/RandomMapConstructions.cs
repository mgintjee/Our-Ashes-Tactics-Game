...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Sorties.Maps.Spawns.Sides;
...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Commons.Maps.Constrs.Models.Implementaions;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Commons.Maps.Constrs.Models.Inters;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Commons.Maps.Spawns.Positions.Impls;
...
namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Activities.Sorties.Generators.Sorties.Maps
{
    /// <summary>
    /// Random Map Constrs
    /// </summary>
