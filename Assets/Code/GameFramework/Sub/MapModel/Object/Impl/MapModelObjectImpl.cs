...
/// MapModelObject Impl
/// </summary>
public class MapModelObjectImpl
    : MapModelObject
{
    ...
    public MapModelObjectImpl(GameFrameworkObject gameFrameworkObject)
    {
        ...
        this.mapModelScript = this.gameFrameworkObject.GetGameFrameworkScript().GetMapModelScript();
