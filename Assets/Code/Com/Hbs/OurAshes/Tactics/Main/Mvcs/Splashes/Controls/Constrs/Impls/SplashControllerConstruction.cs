...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Controls.Constrs.Inters;
using System.Collections.Generic;

namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Controls.Constrs.Impls
{
    /// <summary>
    /// Splash Control Interface
    /// </summary>
    public class SplashControlConstruction : ISplashControlConstruction
    {
        /// <summary>
        /// Todo
        /// </summary>
