...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Weapons.Objects
{
    /// <summary>
    /// Weapon Object Impl
    /// </summary>
    ...
    : IWeaponObject
    {
        ...
        // Todo
        private readonly WeaponIdEnum weaponId = WeaponIdEnum.None;
        ...
        /// <param name="weaponId">
        /// </param>
        public WeaponObjectImpl(IWeaponScript weaponScript, WeaponIdEnum weaponId)
        {
            if (weaponScript != null &&
                weaponId != WeaponIdEnum.None)
            {
            ...
            else
            {
                throw ArgumentExceptionUtil.Build("Unable to construct ?. Invalid Parameters. " +
                    ...
                    typeof(WeaponIdEnum), weaponId.Equals(WeaponIdEnum.None));
            }
        }
