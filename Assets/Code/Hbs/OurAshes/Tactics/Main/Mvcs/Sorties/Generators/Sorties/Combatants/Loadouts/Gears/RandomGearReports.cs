...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Commons.Loadouts.Reports.Gears.Impls;
...
namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Generators.Sorties.Combatants.Loadouts.Gears
{
    /// <summary>
    /// Random Gear Reports
    /// </summary>
