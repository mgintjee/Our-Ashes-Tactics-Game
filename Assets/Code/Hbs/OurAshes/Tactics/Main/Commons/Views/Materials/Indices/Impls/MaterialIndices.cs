using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Views.Materials.Indices.Inters;

namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Views.Materials.Indices.Impls
{
    /// <summary>
    /// Todo
    /// </summary>
