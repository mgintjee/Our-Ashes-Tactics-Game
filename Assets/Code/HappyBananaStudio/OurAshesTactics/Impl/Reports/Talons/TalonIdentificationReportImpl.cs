...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Impl.Reports.Talons
{
        ...
        : ITalonIdentificationReport
    {
        ...
        // Todo
        private readonly TalonModelIdEnum talonId;
        ...
        /// <returns>
        /// </returns>
        public TalonModelIdEnum GetTalonId()
        {
            return this.talonId;
        }
        ...
        public override string ToString()
        {
            return this.GetType().Name + ":" +
                "\n\t>" + typeof(TalonModelIdEnum).Name + "=" + this.GetTalonId() +
        ...
        public class Builder
        {
            ...
            /// The Builder to continue building with
            /// </returns>
            public Builder SetTalonId(TalonModelIdEnum talonId)
            {
                this.talonId = talonId;
                return this;
            }
