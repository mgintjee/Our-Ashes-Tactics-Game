namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.TurnOrders.Reports.Impl
{
    ...
    /// Todo
    /// </summary>
    public struct TurnOrderReportImpl
        : ITurnOrderReport
    {
        // Todo
        ...
        private TurnOrderReportImpl(int phaseCount, IList<TalonCallSign> orderedTalonCallSignList)
        {
        ...
        public class Builder
        {
            ...
            public ITurnOrderReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TurnOrderReportImpl(this.phaseCount, this.orderedTalonCallSignList);
                }
                else
                {
