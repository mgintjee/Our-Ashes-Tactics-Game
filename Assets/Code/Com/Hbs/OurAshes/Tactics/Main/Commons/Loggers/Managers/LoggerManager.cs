using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Mvcs.Impls;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Mvcs.Inters;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Commons.Frames.Types;
using System.Collections.Generic;

namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Managers
{
    /// <summary>
