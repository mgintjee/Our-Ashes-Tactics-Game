...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Commons.Views.Canvases.Widgets.Implementations.Complexes.Abstracts
{
    /// <summary>
    /// Todo
    /// </summary>
    public abstract class AbstractComplexWidget
        : AbstractBasicWidget
    {
        // Todo
