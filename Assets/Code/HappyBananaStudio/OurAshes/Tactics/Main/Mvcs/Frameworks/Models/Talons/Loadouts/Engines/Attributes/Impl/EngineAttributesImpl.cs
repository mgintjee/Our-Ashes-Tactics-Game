namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Loadouts.Engines.Attributes.Impl
{
        ...
        : IEngineAttributes
    {
        ...
        private EngineAttributesImpl(float movementPoints, float actionPoints)
        {
