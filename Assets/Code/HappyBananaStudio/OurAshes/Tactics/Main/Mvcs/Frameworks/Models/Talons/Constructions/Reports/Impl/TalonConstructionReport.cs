namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Constructions.Reports.Impl
{
        ...
        : ITalonConstructionReport
    {
        ...
        private TalonConstructionReport(ICustomizationReport customizationReport, ITalonLoadoutReport talonLoadoutReport)
        {
        ...
        public class Builder
        {
            ...
            public ITalonConstructionReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonConstructionReport(this.customizationReport, this.talonLoadoutReport);
                }
                else
                {
