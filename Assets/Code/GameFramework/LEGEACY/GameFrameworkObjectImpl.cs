    ...
    : GameFrameworkObject
{
    ...
    public override void CreateNewMechFrom(MechConstructionReport mechCreationReport)
    {
            ...
            this.ValidMechCount(mechCreationReport.GetTeamId()))
        {
            ...
            int mechPosition = -1;
            TeamIdEnum teamId = mechCreationReport.GetTeamId();
            ...
            */
            this.mapModelObject.AddNewMechObject(mechScript.GetMechObject(), teamId, mechPosition);
            ...
            Transform mapModelMechTeamCollectionTransform = mapModelMechCollectionTransform.Find("Team: " + teamId);
            if (mapModelMechTeamCollectionTransform == null)
            {
                GameObject mapModelMechTeamCollectionGameObject = new GameObject("Team: " + teamId);
