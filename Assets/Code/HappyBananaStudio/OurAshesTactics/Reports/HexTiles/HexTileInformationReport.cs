...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.HexTiles
{
    ...
    /// Todo
    /// </summary>
    public struct HexTileInformationReport
        : IHexTileInformationReport
    {
        ...
        /// </param>
        public HexTileInformationReport(IHexTileAttributes hexTileAttributes, IHexTileConstructionReport hexTileConstructionReport, ITalonIdentificationReport talonIdentificationReport)
        {
        ...
        public class Builder
        {
            ...
            public IHexTileInformationReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new HexTileInformationReport(this.hexTileAttributes,
