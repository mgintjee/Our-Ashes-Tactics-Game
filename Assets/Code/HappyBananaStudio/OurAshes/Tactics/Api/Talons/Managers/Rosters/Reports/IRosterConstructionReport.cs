...
namespace HappyBananaStudio.OurAshes.Tactics.Api.Rosters.Reports
{
    ...
    public interface IRosterConstructionReport
    {
        ...
        /// <returns>
        /// </returns>
        IDictionary<FactionId, ISet<PhalanxId>> GetFactionIdPhalanxIdSetIDictionary();
        ...
        /// <returns>
        /// </returns>
        IDictionary<PhalanxId, ISet<ITalonConstructionReport>> GetPhalanxIdTalonConstructionReportIDictionary();
    }
}
