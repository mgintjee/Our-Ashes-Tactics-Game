...
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Internals.Loggers.Mvcs.Impls;
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Frames.Types;
using System.Collections.Generic;

namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Managers.Loggers
{
    /// <summary>
