...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Talons.Models.Pathing.Finders.Impl
{
        ...
        : AbstractPathFinder
    {
        ...
        /// </param>
        private PathFinderMove(ICubeCoordinates tileCoordinatesStart, float pathCostThreshold)
        ...
        {
            logger.Debug("BeginPathFinding for pathCostThreshold=?", this.pathCostThreshold);
        ...
        private void DijkstraAlgorithm()
        {
            ...
            while (unvisitedCubeCoordinatesSet.Count > 0)
            {
                ...
                if (closestCubeCoordinates != null)
                {
                    ...
                    ISet<ICubeCoordinates> closestCubeCoordinatesNeighborSet = GameBoardManager
                    ...
                    foreach (ICubeCoordinates neighborCubeCoordinates in closestCubeCoordinatesNeighborSet)
                    {
                        ...
                        if (this.pathObjectDictionary.ContainsKey(neighborCubeCoordinates))
                        {
                            ...
                            IHexTileObject neighborHexTileObject = GameBoardManager
        ...
        private void GatherAllCubeCoordinatesEnds()
        {
            ...
            foreach (ICubeCoordinates cubeCoordinates in GameBoardManager.GetAllCubeCoordinatesSet())
            {
                IHexTileObject tileObject = GameBoardManager.GetHexTileObjectFrom(cubeCoordinates);
        ...
        public class Builder
        {
            ...
            public IPathFinder Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new PathFinderMove(this.startingCubeCoordinates, this.pathCostThreshold);
                }
