...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Talons
{
    ...
    /// Todo
    /// </summary>
    public struct TalonInformationReport
        : ITalonInformationReport
    {
        ...
        /// </param>
        private TalonInformationReport(IHopliteReport hopliteReport,
        ...
        public class Builder
        {
            ...
            public ITalonInformationReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonInformationReport( this.hopliteReport,
            ...
            /// </returns>
            public Builder SetTalonAttributesReport(IHopliteReport hopliteReport)
            {
                this.hopliteReport = hopliteReport;
                return this;
            }
