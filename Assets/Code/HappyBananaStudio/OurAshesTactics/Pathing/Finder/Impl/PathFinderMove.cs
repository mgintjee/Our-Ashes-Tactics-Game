...
namespace HappyBananaStudio.OurAshesTactics.Mvc.Pathing.Finder.Impl
{
    ...
    : PathFinderAbstract
    {
        ...
        private void GatherAllPathObjects()
        {
            ...
            while (unvisitedCubeCoordinatesSet.Count > 0)
            {
                    ...
                    unvisitedCubeCoordinatesSet.Count <= 0)
                {
                    ...
                    HashSet<CubeCoordinates> closestCubeCoordinatesNeighborSet = MapObjectManager.GetNeighborCubeCoordinates(closestCubeCoordinates);
                    ...
                    {
                        // Generate a new Neighbor PathObject using the closest CubeCoordinates
                        IPathObject neighborPathObject = this.PathFindForNeighbor(closestCubeCoordinates,
                            neighborCubeCoordinates,
                            visitedCubeCoordinatesSet,
                            unvisitedCubeCoordinatesSet);
        ...
        private void GatherAllTileCoordinatesEnds()
        {
            ...
            foreach (CubeCoordinates cubeCoordinates in MapObjectManager.GetAllCubeCoordinatesSet())
            {
        ...
        /// <returns></returns>
        private IPathObject PathFindForNeighbor(CubeCoordinates currentCubeCoordinates,
            CubeCoordinates neighborCubeCoordinates,
            HashSet<CubeCoordinates> visitedCubeCoordinatesSet,
            HashSet<CubeCoordinates> unvisitedCubeCoordinatesSet)
        {
            IPathObject oldNeighborPathObject = null;
            IHexTileObject neighborTileObject = MapObjectManager.FindHexTileObjectFrom(neighborCubeCoordinates);
