...
public class TalonAttributes
{
    ...
    public class Builder
    {
        ...
        private HashSet<string> IsValid()
        {
            ...
            if (this.armourPoints < 0)
            {
                argumentExceptionSet.Add("armourPoints=" + this.armourPoints + " is not valid");
            }
            // Check that healthPoints has been set
            if (this.healthPoints < 0)
            {
                argumentExceptionSet.Add("healthPoints=" + this.healthPoints + " is not valid");
            }
            // Check that turnPoints has been set
            if (this.turnPoints < 0)
            {
                argumentExceptionSet.Add("turnPoints=" + this.turnPoints + " is not valid");
            }
            // Check that movePoints has been set
            if (this.movePoints < 0)
            {
                argumentExceptionSet.Add("movePoints=" + this.movePoints + " is not valid");
            }
            // Check that weaponPoints has been set
            if (this.weaponPoints < 0)
            {
                argumentExceptionSet.Add("weaponPoints=" + this.weaponPoints + " is not valid");
            }
