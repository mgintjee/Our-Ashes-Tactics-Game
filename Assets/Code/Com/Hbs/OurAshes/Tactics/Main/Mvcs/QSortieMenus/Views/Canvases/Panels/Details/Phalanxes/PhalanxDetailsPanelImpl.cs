...
namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.QSortieMenus.Views.Canvases.Panels.Details.Phalanxes
{
    /// <summary>
    /// Panel Widget Impl
    /// </summary>
        ...
        : AbstractPanelWidget, IDetailsPanelWidget
    {
        ...
        private IPanelWidget BuildBannerWidget()
        {
            return BannerPanelImpl.Builder.Get()
                .SetText(RequestType.PhalanxDetails.ToString())
