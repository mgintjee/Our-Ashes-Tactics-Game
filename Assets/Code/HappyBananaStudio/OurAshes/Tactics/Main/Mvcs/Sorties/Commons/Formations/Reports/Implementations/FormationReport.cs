...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Sorties.Commons.Formations.Reports.Implementations
{
    /// <summary>
    /// Todo
    /// </summary>
        ...
        : IFormationReport
    {
        ...
        private FormationReport(FormationType formationType, ISet<PhalanxCallSign> activePhalanxCallSigns,
        ...
        /// <inheritdoc/>
        ISet<PhalanxCallSign> IFormationReport.GetActivePhalanxCallSigns()
        {
            return new HashSet<PhalanxCallSign>(_activePhalanxCallSigns);
        }

        /// <inheritdoc/>
        ISet<PhalanxCallSign> IFormationReport.GetAllPhalanxCallSigns()
        {
            return new HashSet<PhalanxCallSign>(_allPhalanxCallSigns);
        }

        /// <inheritdoc/>
        FormationType IFormationReport.GetFormation()
        {
            return _formationType;
        }

        /// <inheritdoc/>
        Optional<IPhalanxReport> IFormationReport.GetPhalanxReport(PhalanxCallSign callSign)
        {
        ...
        public class Builder
        {
            ...
            public IFormationReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new FormationReport(_formationType, _activePhalanxCallSigns,
            ...
            public Builder SetActivePhalanxCallSigns(ISet<PhalanxCallSign> activePhalanxCallSigns)
            {
                ...
                {
                    this._activePhalanxCallSigns = new HashSet<PhalanxCallSign>(activePhalanxCallSigns);
                }
                return this;
            }
            ...
            public Builder SetAllPhalanxCallSigns(ISet<PhalanxCallSign> allPhalanxCallSigns)
            {
                ...
                {
                    this._allPhalanxCallSigns = new HashSet<PhalanxCallSign>(allPhalanxCallSigns);
                }
                return this;
            }
            ...
            public Builder SetPhalanxReports(ISet<IPhalanxReport> phalanxReports)
            {
                ...
                {
                    this._phalanxReports = new HashSet<IPhalanxReport>(phalanxReports);
                }
                return this;
            }
