namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Loadouts.Attributes.Impl
{
    ...
    /// Todo
    /// </summary>
    public struct TalonLoadoutAttributesImpl
        : ITalonLoadoutAttributes
    {
        ...
        private TalonLoadoutAttributesImpl(IArmorAttributes armorAttributes,
        ...
        public class Builder
        {
            ...
            public ITalonLoadoutAttributes Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonLoadoutAttributesImpl(this.armorAttributes,
