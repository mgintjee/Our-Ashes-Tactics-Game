namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Objects.Impl
{
        ...
        : IDestructibleObject
    {
        ...
        private DestructibleObjectImpl(IArmorAttributes armorAttributes)
        {
        ...
        public DestructibleObjectImpl(IDestructibleObject destructibleObject)
        {
        ...
        /// <inheritdoc/>
        void IDestructibleObject.InputDestructableCosts(float armorDamage, float healthDamage)
        {
            this.currentArmorPoints -= armorDamage;
            this.currentHealthPoints -= healthDamage;
        }

        /// <inheritdoc/>
        void IDestructibleObject.ResetForNewPhase()
        {
        ...
        public class Builder
        {
            ...
            public IDestructibleObject Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new DestructibleObjectImpl(this.armorAttributes);
                }
                else
                {
            ...
            {
                return new DestructibleObjectImpl(destructibleObject);
            }
