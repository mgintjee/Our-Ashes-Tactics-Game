using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Builders.Widgets.Implementations;
...
namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Commons.Views.Widgets.Implementations.Abstracts.Basics
{
    /// <summary>
    /// Todo
    /// </summary>
