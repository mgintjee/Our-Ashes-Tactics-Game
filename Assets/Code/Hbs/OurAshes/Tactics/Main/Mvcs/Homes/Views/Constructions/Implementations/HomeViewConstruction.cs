...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Homes.Views.Constructions.Interfaces;
using System.Collections.Generic;

namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Homes.Views.Constructions.Implementations
{
    /// <summary>
