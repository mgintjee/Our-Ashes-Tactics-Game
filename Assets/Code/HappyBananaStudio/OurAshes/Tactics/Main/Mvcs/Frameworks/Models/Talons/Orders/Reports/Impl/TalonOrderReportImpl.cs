namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Orders.Reports.Impl
{
    ...
    /// Todo
    /// </summary>
    public struct TalonOrderReportImpl
        : ITalonOrderReport
    {
        // Todo
        ...
        // Todo
        private readonly OrderType actionType;
        ...
        private TalonOrderReportImpl(TalonCallSign talonCallSign, OrderType actionType, IPathObject pathObject)
        {
        ...
        /// </summary>
        /// <returns></returns>
        OrderType ITalonOrderReport.GetActionType()
        {
        ...
        public class Builder
        {
            ...
            public ITalonOrderReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonOrderReportImpl(this.actingTalonCallSign, this.actionType, this.pathObject);
                }
                else
                {
