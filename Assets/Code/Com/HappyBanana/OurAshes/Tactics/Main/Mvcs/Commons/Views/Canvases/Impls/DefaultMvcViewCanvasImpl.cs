...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Views.Canvases.Impls
{
    /// <summary>
    /// Mvc View Canvas Implementation
    /// </summary>
    public class DefaultMvcViewCanvasImpl
        : AbstractMvcViewCanvas, IMvcViewCanvas
    {
        ...
        public class Builder
        {
                ...
                : AbstractViewCanvasBuilders.AbstractViewCanvasBuilder, IInternalBuilder
            {
                ...
                {
                    IMvcViewCanvas mvcViewCanvas = gameObject.AddComponent<DefaultMvcViewCanvasImpl>();
