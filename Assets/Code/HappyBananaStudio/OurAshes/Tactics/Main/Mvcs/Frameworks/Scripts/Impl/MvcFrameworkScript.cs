using Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Common.Generators.Talons.Customizations;
using Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Common.Generators.Talons.Loadouts;
...
using Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Views.UIs.Canvases.Configurations.Canvases.Reports.Impl;
        ...
        : AbstractUnityScript, IMvcFrameworkScript
    {
        ...
        private void Initialize()
        {
            ...
            if (this.mvcFrameworkObject == null)
            {
                ...
                ICanvasConfigurationReport viewConfigurationReport = CanvasConfigurationReport.DefaultViewConfigurationReport();
