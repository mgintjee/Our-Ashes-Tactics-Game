namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Actions.Reports.Impl
{
    ...
    /// Todo
    /// </summary>
    public struct TalonActionReportImpl
        : ITalonActionReport
    {
        // Todo
        ...
        private TalonActionReportImpl(TalonCallSign talonCallSign, ISet<ITalonOrderReport> talonActionOrderReportSet)
        {
        ...
        public class Builder
        {
            ...
            public ITalonActionReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonActionReportImpl(this.talonCallSign, this.talonActionOrderReportSet);
                }
                else
                {
