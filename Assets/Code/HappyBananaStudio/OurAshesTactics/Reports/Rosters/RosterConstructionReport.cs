...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Rosters
{
    ...
    /// Todo
    /// </summary>
    public struct RosterConstructionReport
        : IRosterConstructionReport
    {
        ...
        /// </param>
        public RosterConstructionReport(
        ...
        public class Builder
        {
            ...
            public IRosterConstructionReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new RosterConstructionReport(this.phalanxIdTalonConstructionReportDictionary, this.factionIdPhalanxIdSetDictionary);
                }
                else
                {
            ...
            {
                this.factionIdPhalanxIdSetDictionary = new Dictionary<FactionIdEnum, HashSet<PhalanxIdEnum>>(
                    this.factionIdPhalanxIdSetDictionary);
                return this;
            }
            ...
            {
                this.phalanxIdTalonConstructionReportDictionary = new Dictionary<PhalanxIdEnum, HashSet<ITalonConstructionReport>>(
                    this.phalanxIdTalonConstructionReportDictionary);
                return this;
            }
