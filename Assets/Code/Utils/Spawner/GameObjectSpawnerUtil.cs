...
/// Todo
/// </summary>
public class GameObjectSpawnerUtil
{
    ...
    private static GameObjectSpawnerUtilScript spawnerUtilScript;
    ...
    private static void CollectSpawnerUtilGameObject()
    {
        ...
        if (spawnerUtilGameObject != null)
        {
            ...
            GameObjectSpawnerUtilScript spawnerUtilScript = spawnerUtilGameObject.GetComponent<GameObjectSpawnerUtilScript>();
            // Check if the SpawnerUtilScript is non-null
            if (spawnerUtilScript != null)
            {
                GameObjectSpawnerUtil.spawnerUtilScript = spawnerUtilScript;
