...
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Loadouts.Cabins.Traits.Attrs.Impls;
...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Loadouts.Cabins.Traits.Attrs.Managers
{
    /// <summary>
    /// Todo
    /// </summary>
