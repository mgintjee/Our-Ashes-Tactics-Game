namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Coordinates.Offset.Impl
{
        ...
        : IOffsetCoordinates
    {
        ...
        /// </param>
        private OffsetCoordinatesImpl(int colCoordinate, int rowCoordinate, OffsetCoordinateType offsetCoordinateType)
        {
        ...
        public class Builder
        {
            ...
            public IOffsetCoordinates Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new OffsetCoordinatesImpl(this.colCoordinate, this.rowCoordinate, this.offsetCoordinateType);
                }
                else
                {
