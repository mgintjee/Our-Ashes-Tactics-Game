...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Game
{
    /// <summary>
    /// Todo
    /// </summary>
    public struct GameActionReport
        : IGameActionReport
    {
        // Todo
        ...
        private GameActionReport(int actionCounter, IGameMapInformationReport gameMapInformationReport,
        ...
        public class Builder
        {
            ...
            public IGameActionReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new GameActionReport(this.actionCounter, this.gameMapInformationReport,
