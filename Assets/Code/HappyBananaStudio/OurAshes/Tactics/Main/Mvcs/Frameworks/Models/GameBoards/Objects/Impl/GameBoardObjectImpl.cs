namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.GameBoards.Objects.Impl
{
    ...
    /// Board Object Impl
    /// </summary>
    public class GameBoardObjectImpl
        : IGameBoardObject
    {
        // Todo
        ...
        private GameBoardObjectImpl(ISet<ICubeCoordinates> cubeCoordinatesSet, bool mirroredBoard)
        {
        ...
        private GameBoardObjectImpl(IGameBoardObject gameBoardObject)
        {
            ...
            foreach (KeyValuePair<ICubeCoordinates, IHexTileObject> entry in gameBoardObject.GetCubeCoordinatesHexTileObjectDictionary())
            {
                this.cubeCoordinatesHexTileObjectDictionary.Add(entry.Key,
                    new HexTileObjectImpl.Builder().Build(entry.Value));
            }
        }
        ...
        IGameBoardReport IGameBoardObject.GetGameBoardReport()
        {
            ...
            return new GameBoardReportImpl.Builder()
        ...
        /// <inheritdoc/>
        IHexTileObject IGameBoardObject.GetHexTileObjectFrom(ICubeCoordinates cubeCoordinates)
        {
            if (cubeCoordinates != null)
            {
                if (this.cubeCoordinatesHexTileObjectDictionary.ContainsKey(cubeCoordinates))
        ...
        public class Builder
        {
            ...
            public IGameBoardObject Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new GameBoardObjectImpl(this.cubeCoordiantesSet, this.mirroredBoard);
                }
                else
                {
            ...
            {
                return new GameBoardObjectImpl(gameBoardObject);
            }
