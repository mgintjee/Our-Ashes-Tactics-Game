...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Homes.Controls.Impls;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Homes.Models.Impls;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Homes.Views.Impls;
using System.Diagnostics;

namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Homes.Frames.Impls
{
    /// <summary>
    /// Home Frame Impl
    /// </summary>
