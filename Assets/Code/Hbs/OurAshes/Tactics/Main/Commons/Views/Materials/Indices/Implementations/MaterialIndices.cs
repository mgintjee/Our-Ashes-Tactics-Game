using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Views.Materials.Indices.Interfaces;

namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Views.Materials.Indices.Implementations
{
    /// <summary>
    /// Todo
    /// </summary>
