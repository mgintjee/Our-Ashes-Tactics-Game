...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Talons.Combat
{
    ...
    /// Todo
    /// </summary>
    public struct TalonCombatOrderReport
        : ITalonCombatOrderReport
    {
        ...
        /// </param>
        private TalonCombatOrderReport(List<IWeaponOrderReport> weaponOrderReportList)
        {
        ...
        public class Builder
        {
            ...
            public ITalonCombatOrderReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonCombatOrderReport(this.weaponOrderReportList);
                }
                else
                {
