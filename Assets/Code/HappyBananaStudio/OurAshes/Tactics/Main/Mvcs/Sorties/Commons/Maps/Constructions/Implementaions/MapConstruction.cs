...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Sorties.Commons.Maps.Constructions.Implementaions
{
    /// <summary>
    /// Todo
    /// </summary>
        ...
        : IMapConstruction
    {
            ...
            IDictionary<CombatantCallSign, ISpawnPosition> combatantCallSignSpawnPositions)
        {
            ...
            _radius = radius;
            _combatantCallSignSpawnPositions = combatantCallSignSpawnPositions;
        }

        /// <inheritdoc/>
        IDictionary<CombatantCallSign, ISpawnPosition> IMapConstruction.GetCombatantCallSignSpawnPosition()
        {
            return new Dictionary<CombatantCallSign, ISpawnPosition>(_combatantCallSignSpawnPositions);
        }
        ...
        public class Builder
        {
            ...
            /// <param name="mirroredMap"></param>
            /// <returns></returns>
            public Builder SetIsMirroredMap(bool mirroredMap)
            {
                _mirroredMap = mirroredMap;
                return this;
            }
            ...
            /// <param name="radius"></param>
            /// <returns></returns>
            public Builder SetSize(int radius)
            {
                _radius = radius;
                return this;
            }
            ...
            /// <returns></returns>
            public Builder SetCombatantCallSignSpawnPositions(IDictionary<CombatantCallSign, ISpawnPosition> combatantCallSignSpawnPositions)
            {
                if (combatantCallSignSpawnPositions != null)
                {
                    _combatantCallSignSpawnPositions =
