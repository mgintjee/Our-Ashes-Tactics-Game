...
using HappyBananaStudio.OurAshesTactics.Mvc.ArtificialIntelligence.Api;
...
namespace HappyBananaStudio.OurAshesTactics.Mvc.Controller.Impl
{
    ...
    : IMvcControllerObject
    {
        ...
        public void BeginDecisionProcess(TalonTurnInformationReport talonTurnInformationReport)
        {
