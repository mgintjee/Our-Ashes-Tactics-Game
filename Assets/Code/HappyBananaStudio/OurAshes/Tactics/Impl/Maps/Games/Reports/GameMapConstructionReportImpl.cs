...
namespace HappyBananaStudio.OurAshesTactics.Impl.Reports.Maps.Game
{
    /// <summary>
    ...
    {
        // Todo
        private readonly ISet<ICubeCoordinates> cubeCoordiantesSet;
        ...
        /// </param>
        private GameMapConstructionReportImpl(ISet<ICubeCoordinates> cubeCoordinatesSet, bool isGameMapMirrored)
        {
        ...
        public override string ToString()
        {
            return this.GetType().Name + ": " +
                "\n\t>IsGameMapMirrored: " + this.isGameMapMirrored +
                "\n\t> Set:" + typeof(ICubeCoordinates).Name + ":[\n\t>" +
                string.Join("\n\t\t>", this.cubeCoordiantesSet)
                + "\n]";
        }
        ...
        /// <returns>
        /// </returns>
        ISet<ICubeCoordinates> IGameMapConstructionReport.GetCubeCoordinatesSet()
        {
        ...
        /// <returns>
        /// </returns>
        bool IGameMapConstructionReport.GetIsGameMapMirrored()
        {
        ...
        {
            // Todo
            private ISet<ICubeCoordinates> cubeCoordiantesSet = null;
            ...
            /// <returns>
            /// </returns>
            public Builder SetCubeCoordinatesSet(ISet<ICubeCoordinates> cubeCoordiantesSet)
            {
