...
using Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Talons.Common.Comparers.Api;
...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Talons.Common.Comparers.Abs
{
    /// <summary>
    /// Todo
    /// </summary>
