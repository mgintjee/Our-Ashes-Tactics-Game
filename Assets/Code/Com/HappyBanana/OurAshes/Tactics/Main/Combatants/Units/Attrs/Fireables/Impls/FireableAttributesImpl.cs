...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Combatants.Units.Attrs.Fireables.Impls
{
    /// <summary>
        ...
        : IFireableAttributes
    {
        ...
        public class Builder
        {
                ...
                : IBuilder<IFireableAttributes>
            {
                ...
                /// <returns></returns>
                IFireableAttributes Build(IList<IFireableAttributes> attributes);
            }
                ...
                : AbstractBuilder<IFireableAttributes>, IInternalBuilder
            {
                ...
                /// <inheritdoc/>
                IFireableAttributes IInternalBuilder.Build(IList<IFireableAttributes> attributes)
                {
                    _accuracy = 0.0f;
                    _range = 0.0f;
