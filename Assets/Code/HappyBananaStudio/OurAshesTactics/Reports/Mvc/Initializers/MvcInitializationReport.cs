...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Mvc.Initializers
{
    /// <summary>
    /// Todo
    /// </summary>
    public struct MvcInitializationReport
        : IMvcInitializationReport
    {
        ...
        /// </param>
        private MvcInitializationReport(IGameMapConstructionReport gameMapConstructionReport,
        ...
        public class Builder
        {
            ...
            public IMvcInitializationReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new MvcInitializationReport(this.gameMapConstructionReport,
