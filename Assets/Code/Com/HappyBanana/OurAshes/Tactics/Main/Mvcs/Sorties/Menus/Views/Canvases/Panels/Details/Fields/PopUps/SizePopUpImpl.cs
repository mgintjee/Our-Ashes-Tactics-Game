...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Sorties.Menus.Views.Canvases.Panels.Details.Fields.PopUps
{
    /// <summary>
    /// Field ID PopUp Impl
    /// </summary>
    public class SizePopUpImpl
        : AbstractStaticEnumPopUp<FieldSize>
    {
        private IFieldDetails fieldDetails;

        protected override bool IsButtonInteractable(FieldSize tEnum)
        {
            return tEnum != this.fieldDetails.GetFieldSize();
        }
        ...
        public class Builder
        {
                ...
                : PanelWidgetBuilders.InternalPanelWidgetBuilder, IInternalBuilder
            {
                ...
                {
                    SizePopUpImpl widget = gameObject.AddComponent<SizePopUpImpl>();
