using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Frames.Sorties.Maps.Tiles.Attributes.Impls;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Frames.Sorties.Maps.Tiles.IDs;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Optionals;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Constants.Sorties.Tiles.Models.Impls;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Constants.Sorties.Tiles.Models.Inters;
using System.Collections.Generic;

namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Constants.Sorties.Tiles.Models.Managers
{
    /// <summary>
    /// Todo
    /// </summary>
