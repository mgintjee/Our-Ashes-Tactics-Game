...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loadouts.Traits.IDs;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loadouts.Traits.Types;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Constants.Loadouts.Models.Gears.Managers;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Constants.Loadouts.Models.Traits.Inters;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Constants.Loadouts.Models.Traits.Managers;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Commons.Loadouts.Reports.Traits.Impls;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Commons.Loadouts.Reports.Traits.Inters;
using System;
