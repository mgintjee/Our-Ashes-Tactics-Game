...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Weapons
{
    ...
    /// Todo
    /// </summary>
    public struct WeaponResultReport
        : IWeaponResultReport
    {
        // Todo
        ...
        /// </param>
        private WeaponResultReport(int damageCaused, int damageMitigated, IWeaponOrderReport weaponOrderReport)
        {
        ...
        public class Builder
        {
            ...
            public IWeaponResultReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new WeaponResultReport(this.damageCaused, this.damageMitigated, this.weaponOrderReport);
                }
                else
                {
