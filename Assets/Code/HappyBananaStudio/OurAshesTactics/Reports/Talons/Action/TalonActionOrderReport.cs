...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Talons.Action
{
    ...
    /// Todo
    /// </summary>
    public struct TalonActionOrderReport
        : ITalonActionOrderReport
    {
        ...
        /// </param>
        private TalonActionOrderReport(IPathObject pathObject, ActionTypeEnum actionType,
            ...
            public ITalonActionOrderReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    if (this.targetTalonIdentificationReport != null)
                    {
                        ...
                        return new TalonActionOrderReport(this.pathObject, this.actionType,
