...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Models.Maps.Coordinates.Cube.Implementations;
...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Models.Maps.PathFinders.Interfaces;
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Models.Maps.Tiles.Implementations;
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Models.Maps.Tiles.Interfaces;
...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Reports.Models.Maps.Implementations;
...
namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Models.Maps.Implementations
{
    /// <summary>
    /// Todo
    /// </summary>
    public class MapModel : IMapModel
    {
        ...
        public MapModel(ISortieMapModelConstruction sortieMapModelConstruction)
        {
            ...
            foreach (ISortieTileModelConstruction sortieTileModelConstruction in
                sortieMapModelConstruction.GetSortieTileModelConstructions())
            {
