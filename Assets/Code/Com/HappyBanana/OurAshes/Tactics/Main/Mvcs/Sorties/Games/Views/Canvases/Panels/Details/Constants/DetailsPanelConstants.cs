...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Sorties.Games.Views.Canvases.Panels.Details.Constants
{
    /// <summary>
    /// Sortie Screen Details Panel Constants
    /// </summary>
    public class DetailsPanelConstants
    {
        public static readonly int PANEL_SIZE_X = 2;
        public static readonly int PANEL_SIZE_Y = 5;
        public static readonly int PANEL_COORDs_X = 8;
