...
namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Models.Maps.PathFinders.Implementaions.Moves
{
    /// <summary>
    /// Todo
    /// </summary>
    public class MovePathFinder : AbstractPathFinder
    {
