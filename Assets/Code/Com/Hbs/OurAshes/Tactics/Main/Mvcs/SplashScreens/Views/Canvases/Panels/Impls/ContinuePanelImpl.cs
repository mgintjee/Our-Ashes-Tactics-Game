...
namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.SplashScreens.Views.Canvases.Panels.Impls
{
    /// <summary>
    /// Todo
    /// </summary>
        ...
        : AbstractPanelWidget
    {
        protected override void InitialBuild()
        {
            this.InternalAddWidget(ImageWidgetImpl.Builder.Get()
                ...
                .SetParent(this)
                .SetName(this.mvcType + ":Continue:" + CanvasWidgetType.Image)
                .Build());
            this.InternalAddWidget(TextWidgetImpl.Builder.Get()
                ...
                .SetWidgetGridSpec(new WidgetGridSpecImpl()
                    ...
                    .SetCanvasGridSize(this.canvasGridConvertor.GetGridSize()))
                .SetParent(this)
                .SetName(this.mvcType + ":Continue:" + CanvasWidgetType.Text)
                .Build());
        }
