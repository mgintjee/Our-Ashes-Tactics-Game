...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Homes.Models.Constructions.Interfaces;
using System.Collections.Generic;

namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Homes.Models.Constructions.Implementations
{
    /// <summary>
