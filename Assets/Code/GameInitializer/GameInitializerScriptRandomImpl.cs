    ...
    : GameInitializerScript
{
    ...
    protected override List<MechConstructionReport> GetMechConstructionReportList()
    {
        ...
        {
            mechCreationReportList.Add(this.GenerateRandomMechInfoReport(i, TeamIdEnum.East));
        }

        for (int i = 0; i < maxMechPerTeam; ++i)
        {
            mechCreationReportList.Add(this.GenerateRandomMechInfoReport(i, TeamIdEnum.West));
        }
    ...
    private MechConstructionReport GenerateRandomMechInfoReport(int id, TeamIdEnum teamId)
    {
        ...
        return new MechConstructionReport.Builder()
            ...
            .SetTeamId(teamId)
            .SetMechTeamIndex(id)
            .SetPaintSchemeReport(TEAM_1_PAINT_SCHEME_REPORT)
