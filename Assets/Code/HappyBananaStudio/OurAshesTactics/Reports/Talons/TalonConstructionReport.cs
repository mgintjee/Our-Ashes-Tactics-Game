...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Talons
{
        ...
        : ITalonConstructionReport
    {
        ...
        // Todo
        private readonly List<UtilityIdEnum> utilityIdList;
        ...
        /// </param>
        private TalonConstructionReport(IHopliteAttributes hopliteAttributes, IPaintSchemeReport paintSchemeReport,
            ITalonIdentificationReport talonIdentificationReport, List<UtilityIdEnum> utilityIdList, List<WeaponIdEnum> weaponIdList)
        {
        ...
        /// <returns>
        /// </returns>
        public List<UtilityIdEnum> GetUtilityIdList()
        {
            return new List<UtilityIdEnum>(this.utilityIdList);
        }
        ...
        public override string ToString()
        {
            return this.GetType().Name + ":" +
                ...
                "\n\t>List: " + typeof(WeaponIdEnum).Name + "=[" + string.Join("\n\t\t>", this.weaponIdList)
                + "\n]" +
                "\n\t>List: " + typeof(UtilityIdEnum).Name + "=[" + string.Join("\n\t\t>", this.utilityIdList)
                + "\n]";
        }
        ...
        public class Builder
        {
            ...
            // Todo
            private List<UtilityIdEnum> utilityIdList = null;
            ...
            public ITalonConstructionReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonConstructionReport(this.hopliteAttributes, this.paintSchemeReport,
            ...
            /// The Builder to continue building with
            /// </returns>
            public Builder SetUtilityList(List<UtilityIdEnum> utilityIdList)
            {
                this.utilityIdList = utilityIdList;
                return this;
            }
            ...
            private HashSet<string> IsInvalid()
            {
                ...
                {
                    argumentExceptionSet.Add("Set: " + typeof(UtilityIdEnum).Name + " has not been set");
                }
                // Check that weaponIdList has been set
                if (this.weaponIdList == null)
                {
                    argumentExceptionSet.Add("Set: " + typeof(WeaponIdEnum).Name + " has not been set");
                }
