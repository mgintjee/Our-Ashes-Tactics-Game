namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Loadouts.Common.Attributes.Impl
{
        ...
        : ILoadoutAttributes
    {
        ...
        private LoadoutAttributesImpl(IArmorAttributes armorAttributes,
        ...
        public class Builder
        {
            ...
            public ILoadoutAttributes Build(ISet<ILoadoutAttributes> loadoutAttributesSet)
            {
                ...
                this.armorAttributes = new ArmorAttributesImpl.Builder().Build(armorAttributesSet);
                this.engineAttributes = new EngineAttributesImpl.Builder().Build(engineAttributesSet);
                this.weaponAttributes = new WeaponAttributesImpl.Builder().Build(weaponAttributesSet);
