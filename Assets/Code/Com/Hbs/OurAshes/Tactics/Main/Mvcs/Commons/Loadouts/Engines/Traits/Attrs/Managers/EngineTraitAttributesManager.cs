...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Commons.Loadouts.Engines.Traits.Attrs.Impls;
...
namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Commons.Loadouts.Engines.Traits.Attrs.Managers
{
    /// <summary>
    /// Todo
    /// </summary>
