namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.HexTiles.Reports.Impl
{
    ...
    /// Todo
    /// </summary>
    public struct HexTileReportImpl
        : IHexTileReport
    {
        // Todo
        ...
        private HexTileReportImpl(ICubeCoordinates cubeCoordinates, HexTileType hexTileType, TalonCallSign talonCallSign)
        {
        ...
        public class Builder
        {
            ...
            public IHexTileReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new HexTileReportImpl(this.cubeCoordinates, this.hexTileType, this.talonCallSign);
                }
                else
                {
