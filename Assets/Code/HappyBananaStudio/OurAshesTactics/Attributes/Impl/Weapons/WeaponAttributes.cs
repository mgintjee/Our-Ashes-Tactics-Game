...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Attributes.Impl.Weapons
{
    /// <summary>
    /// Todo
    /// </summary>
        ...
        : IWeaponAttributes
    {
        ...
        /// </param>
        /// <param name="rangeProximityPoints">
        /// </param>
        private WeaponAttributes(int accuracyPoints, int damagePoints,
            int numberOfShots, int penetrationPoints,
            int rangePoints, int rangeProximityPoints)
        {
        ...
        /// </param>
        private WeaponAttributes(ICollection<IWeaponAttributes> weaponAttributesCollection)
        {
            ...
            foreach (IWeaponAttributes weaponAttributes in weaponAttributesCollection)
            {
                ...
                rangePoints += weaponAttributes.GetRangePoints();
                rangeProximityPoints += weaponAttributes.GetRangeProximityPoints();
            }
        ...
        public class Builder
        {
            ...
            // Todo
            private bool setRangeProximityPoints = false;
            ...
            public IWeaponAttributes Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    if (this.weaponAttributesCollection != null)
                    {
                        ...
                        return new WeaponAttributes(this.weaponAttributesCollection);
                    }
                    else
                    {
                        // Instantiate a new Report
                        return new WeaponAttributes(this.accuracyPoints, this.damagePoints,
                            this.numberOfShots, this.penetrationPoints,
                            this.rangePoints, this.rangeProximityPoints);
                    }
                }
                else
                {
            ...
            /// </summary>
            /// <param name="rangeProximityPoints">
            /// The rangeProximityPoints to set
            /// </param>
            /// <returns>
            /// The Builder to continue building with
            /// </returns>
            ...
            {
                this.rangeProximityPoints = rangeProximityPoints;
                this.setRangeProximityPoints = true;
                return this;
            }
            ...
            private HashSet<string> IsInvalid()
            {
                ...
                if (this.weaponAttributesCollection == null)
                {
                    ...
                    if (!this.setRangeProximityPoints)
                    {
                        argumentExceptionSet.Add("rangeProximityPoints has not been set");
                    }
                    // Check if any other errors have been caught
                    if (argumentExceptionSet.Count == 0)
                    {
                        argumentExceptionSet.Add("Collection: " + typeof(IWeaponAttributes).Name + " has not been set");
                    }
                }
                else
                {
