...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Views.UIs.Canvases.PanelEntries.Impl.Informationals.Objects.Impl
{
    ...
    /// Todo
    /// </summary>
    public class ComplexWidgetInformationalObjectHexTile
        : AbstractComplexWidgetInformationalObject
    {
        ...
        public class Builder
        {
            ...
            public IComplexWidgetInformational Build()
            {
                ...
                {
                    ComplexWidgetInformationalObjectHexTile informationalComplexWidget =
                        new GameObject(typeof(ComplexWidgetInformationalObjectHexTile).Name)
                        .AddComponent<ComplexWidgetInformationalObjectHexTile>();
