...
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Internals.Loggers.Consoles.Impls;
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Utils.Strings;
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Frames.Types;
using System;

namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Internals.Loggers.Classes.Impls
{
    /// <summary>
    /// Todo
    /// </summary>
