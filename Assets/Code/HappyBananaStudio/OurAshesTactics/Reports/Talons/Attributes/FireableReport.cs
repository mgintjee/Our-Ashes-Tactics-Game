...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Talons.Attributes
{
        ...
        : IFireableReport
    {
        ...
        /// </param>
        private FireableReport(List<IWeaponInformationReport> weaponAttributeList)
        {
            ...
            this.weaponInformationReportList.ForEach(
                weaponId =>
                {
                    if (weaponId.GetWeaponId().Equals(WeaponIdEnum.None))
                    {
                        weaponCounter++;
                    }
                }
        ...
        public class Builder
        {
            ...
            public IFireableReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new FireableReport(this.weaponInformationReportList);
                }
                else
                {
