using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Classes.Impls;
...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Files.Impls;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Files.Inters;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Mvcs.Inters;
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Commons.Frames.Types;
using System;
using System.Collections.Generic;
using System.IO;

namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Mvcs.Impls
{
    /// <summary>
    /// Todo
    /// </summary>
