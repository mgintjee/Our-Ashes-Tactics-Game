...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Consoles.Impls;
using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Consoles.Inters;
using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Constants;
using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Files.Inters;
using System;

namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Classes.Impls
{
    /// <summary>
    /// Todo
    /// </summary>
