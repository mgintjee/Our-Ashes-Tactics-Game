...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Combatants.Loadouts.Armors.Gears.Details.Impls
{
    /// <summary>
        ...
        : IArmorGearDetails
    {
        ...
        /// <inheritdoc/>
        ArmorGearID IArmorGearDetails.GetGearID()
        {
            return this.armorGearID;
        }

        /// <inheritdoc/>
        ISet<ArmorTraitID> IArmorGearDetails.GetTraitIDs()
        {
