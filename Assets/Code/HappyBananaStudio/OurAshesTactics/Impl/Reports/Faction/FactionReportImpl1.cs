...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Impl.Reports.Faction
{
        ...
        : IFactionReport
    {
        ...
        /// </param>
        private FactionReportImpl(FactionIdEnum factionIdenum, HashSet<IPhalanxReport> phalanxReportSet)
        {
        ...
        public class Builder
        {
            ...
            public IFactionReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new FactionReportImpl(this.factionId, this.phalanxReportSet);
                }
                else
                {
