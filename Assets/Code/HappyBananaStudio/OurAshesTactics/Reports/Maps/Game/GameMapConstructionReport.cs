...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Maps.Game
{
    /// <summary>
    /// Report used to generate the Map
    /// </summary>
    public struct GameMapConstructionReport
...

    {
        ...
        /// </param>
        private GameMapConstructionReport(HashSet<ICubeCoordinates> cubeCoordinatesSet, bool isGameMapMirrored)
        {
        ...
        public class Builder
        {
            ...
            public IGameMapConstructionReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new GameMapConstructionReport(this.cubeCoordiantesSet, this.isGameMapMirrored);
                }
                else
                {
