...
namespace HappyBananaStudio.OurAshesTactics.Mvc.Model.Sub.Talon.Reports
{
    ...
    /// Todo
    /// </summary>
    public class TalonActionInformationReport
    {
        ...
        /// </param>
        private TalonActionInformationReport(HashSet<TalonActionOrderReport> possibleTalonActionOrderReportSet,
        ...
        public class Builder
        {
            ...
            public TalonActionInformationReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonActionInformationReport(this.possibleTalonActionOrderReportSet,
