namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Views.UIs.Canvases.Impl.Informationals.Impl
{
    ...
    /// Todo
    /// </summary>
    public class CanvasInformational
        : AbstractCanvas, ICanvasInformational
    {
        /// <summary>
        /// Todo
        /// </summary>
        ...
        public class Builder
        {
            ...
            /// </summary>
            /// <returns></returns>
            public ICanvasInformational Build()
            {
                ISet<string> invalidReasons = this.IsInvalid();
                // Check that the set parameters are valid
                if (invalidReasons.Count == 0)
                {
                    CanvasInformational canvasInformational = new GameObject(typeof(CanvasInformational).Name)
                        .AddComponent<CanvasInformational>();
