...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Sorties.Games.Views.Canvases.Panels.Scrollers.Constants
{
    /// <summary>
    /// Button Panel Constants
    /// </summary>
    public class ScrollerPanelConstants
    {
        public static readonly int PANEL_SIZE_X = 6;
        public static readonly int PANEL_SIZE_Y = 1;
        public static readonly int PANEL_COORDs_X = 2;
        public static readonly int PANEL_COORDS_Y = 5;
        public static readonly int BUTTON_PANEL_X = 1;
        public static readonly int BUTTON_PANEL_Y = 6;
