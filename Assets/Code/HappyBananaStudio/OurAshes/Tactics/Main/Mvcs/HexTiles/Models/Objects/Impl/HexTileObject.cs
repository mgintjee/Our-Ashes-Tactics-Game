namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.HexTiles.Models.Objects.Impl
{
    ...
    using Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.HexTiles.Models.Reports.Impl;
        ...
        : IHexTileObject
    {
        ...
        private HexTileObject(ICubeCoordinates cubeCoordinates, HexTileType hexTileType)
        {
        ...
        private HexTileObject(IHexTileObject hexTileObject)
        {
        ...
        {
            return new HexTileReport.Builder()
        ...
        public class Builder
        {
            ...
            public IHexTileObject Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new HexTileObject(this.cubeCoordinates, this.hexTileType);
                }
            ...
            { return new HexTileObject(hexTileObject); }
