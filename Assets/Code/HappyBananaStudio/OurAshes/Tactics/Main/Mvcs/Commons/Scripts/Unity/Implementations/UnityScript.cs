...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Commons.Scripts.Unity.Implementations
{
    /// <summary>
    /// Todo
    /// </summary>
    public class UnityScript : MonoBehaviour, IUnityScript
    {
        /// <inheritdoc/>
