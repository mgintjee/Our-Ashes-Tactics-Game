...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Talons.Common.Reports.Impl
{
    /// <summary>
    /// Todo
    /// </summary>
        ...
        : ITalonReport
    {
        ...
        private TalonReport(TalonCallSign talonCallSign, ITalonAttributesReport currentTalonAttributesReport,
            ...
            ITalonLoadoutReport talonLoadoutReport, ITalonCustomizationReport talonCustomizationReport)
        {
        ...
        /// <inheritdoc/>
        ITalonCustomizationReport ITalonReport.GetTalonCustomizationReport()
        {
        ...
        public class Builder
        {
            ...
            /// <returns></returns>
            public Builder SetTalonCustomizationReport(ITalonCustomizationReport customizationReport)
            {
            ...
            private ISet<string> IsInvalid()
            {
                ...
                {
                    argumentExceptionSet.Add(typeof(ITalonCustomizationReport) + " has not been set");
                }
