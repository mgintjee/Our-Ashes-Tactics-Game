...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Models.Constructions.Interfaces;
using System.Collections.Generic;

namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Models.Constructions.Implementations
{
    /// <summary>
