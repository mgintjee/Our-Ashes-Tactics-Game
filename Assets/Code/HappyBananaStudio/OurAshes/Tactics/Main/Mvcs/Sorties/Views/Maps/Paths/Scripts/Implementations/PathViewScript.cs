...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Sorties.Views.Maps.Paths.Scripts.Implementations
{
    /// <summary>
    /// Path View Script Implementation
    /// </summary>
    public class PathViewScript : AbstractUnityScript, IPathViewScript
    {
        /// <summary>
        /// Todo
        /// </summary>
