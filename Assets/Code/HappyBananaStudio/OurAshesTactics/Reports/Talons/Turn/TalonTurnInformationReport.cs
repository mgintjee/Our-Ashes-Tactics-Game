...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Talons.Turn
{
    ...
    /// Todo
    /// </summary>
    public struct TalonTurnInformationReport
        : ITalonTurnInformationReport
    {
        ...
        /// </param>
        private TalonTurnInformationReport(HashSet<ITalonActionOrderReport> talonActionOrderReportSet,
        ...
        public class Builder
        {
            ...
            public ITalonTurnInformationReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonTurnInformationReport(this.talonActionOrderReportSet, this.talonInformationReport);
                }
                else
                {
