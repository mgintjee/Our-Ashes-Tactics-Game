/*namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Views.UIs.Canvases.Widgets.Impl.Complex.CanvasEntries.Impl.TurnScrollers
{
    using System.Diagnostics;
    using UnityEngine;

    /// <summary>
    /// SingleTurnScrollerEntry Widget Impl
    /// </summary>
    public class SingleTurnScrollerEntryWidgetImpl
        : AbstractComplexWidgetImpl, ITurnScrollerEntryWidget
    {
        ...
        protected override void LoadChildWidgets()
        {
            ...
            this.talonEmblemWidget = UIResourceLoader.WidgetUIs.Complex.LoadTalonSingleEmblemWidget(this.GetTransform());
