...
using Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Common.Colors.RGBs.Impl;
...
namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Common.Colors.Constants
{
    ...
    {
        // Todo
        private static readonly IDictionary<ColorId, IRGB> colorRGBDictionary =
        ...
        public static Color GetUnityColor(ColorId colorId)
        {
            ...
            {
                IRGB rgb = colorRGBDictionary[colorId];
