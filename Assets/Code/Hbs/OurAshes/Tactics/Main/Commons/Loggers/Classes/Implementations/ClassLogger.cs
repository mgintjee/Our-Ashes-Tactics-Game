...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Consoles.Implementations;
...
namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Commons.Loggers.Classes.Implementations
{
    /// <summary>
    /// Todo
    /// </summary>
