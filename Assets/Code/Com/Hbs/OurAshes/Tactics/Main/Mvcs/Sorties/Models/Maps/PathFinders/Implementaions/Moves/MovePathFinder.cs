...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Models.Maps.PathFinders.Implementaions.Abstrs;
...
namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Sorties.Models.Maps.PathFinders.Implementaions.Moves
{
    /// <summary>
    /// Todo
    /// </summary>
        ...
        : AbstractPathFinder
    {
        ...
        {
            logger.Debug("PathFind @ {} for movements={}", _cubeCoordinates, _movements);
            DijkstraAlgorithm();
