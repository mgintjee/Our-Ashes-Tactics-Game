...
using Assets.Code.HappyBananaStudio.OurAshesTactics.Weapons.Scripts;
...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Common.Talons
{
    ...
    public static class TalonObjectBuilderUtil
    {
        ...
        internal static ITalonObject BuildTalonObject(FactionIdEnum factionId, PhalanxIdEnum phalanxId, ITalonConstructionReport talonConstructionReport)
        {
