...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Talons.Attributes
{
        ...
        : ITalonAttributesReport
    {
        ...
        /// </param>
        private TalonAttributesReport(IDestructibleReport destructibleReport, IFireableReport fireableReport, IMovableReport movableReport)
        {
        ...
        public class Builder
        {
            ...
            public ITalonAttributesReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonAttributesReport(this.destructibleReport,
