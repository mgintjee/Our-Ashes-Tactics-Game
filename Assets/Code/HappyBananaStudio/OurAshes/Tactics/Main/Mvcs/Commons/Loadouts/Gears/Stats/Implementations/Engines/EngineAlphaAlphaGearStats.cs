...
{
    /// <summary>
    /// Engine Alpha Alpha Gear Stats Implementation
    /// </summary>
    public class EngineAlphaAlphaGearStats
        : AbstractGearStats
    {
        /// <summary>
        /// Todo
        /// </summary>
        public EngineAlphaAlphaGearStats()
        {
            _gearID = GearID.EngineAlphaAlpha;
            ...
            _traitCount = 1;
            _traitTypes = new HashSet<TraitType>() { TraitType.EngineAlpha };
