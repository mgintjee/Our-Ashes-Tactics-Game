...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Maps.Game
{
    ...
    /// Todo
    /// </summary>
    public struct GameMapInformationReport
        : IGameMapInformationReport
    {
        ...
        /// </param>
        private GameMapInformationReport(HashSet<IHexTileInformationReport> hexTileInformationReportSet)
        {
        ...
        public class Builder
        {
            ...
            public IGameMapInformationReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new GameMapInformationReport(this.hexTileInformationReportSet);
                }
                else
                {
