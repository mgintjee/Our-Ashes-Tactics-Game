...
namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Activities.Sorties.Reports.Models.Maps.Impls
{
    /// <summary>
    /// Todo
    /// </summary>
    public class SortieMapReport
        : AbstractReport, ISortieMapReport
    {
