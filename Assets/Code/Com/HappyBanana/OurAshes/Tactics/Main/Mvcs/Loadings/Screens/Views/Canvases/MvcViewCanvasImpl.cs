...
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Loadings.Screens.Views.Canvases.Panels.Impls;
using System.Collections.Generic;
using System.Numerics;

namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Loadings.Screens.Views.Canvases
{
    /// <summary>
        ...
        : AbstractMvcViewCanvas, IMvcViewCanvas
    {
        public override void InitialBuild()
        {
            List<ICanvasWidget> canvasWidgets = new List<ICanvasWidget>()
            {
                ...
                this.BuildBanner(),
                TipsPanelImpl.Builder.Get()
                    .SetPanelGridSize(new Vector2(2, 1))
                    .SetWidgetGridSpec(new WidgetGridSpecImpl()
                        .SetCanvasGridCoords(new Vector2(0, this.canvasGridConvertor.GetGridSize().Y / 7))
