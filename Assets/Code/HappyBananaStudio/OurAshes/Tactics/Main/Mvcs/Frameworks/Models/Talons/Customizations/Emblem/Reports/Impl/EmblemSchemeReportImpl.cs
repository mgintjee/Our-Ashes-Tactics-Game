namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Customizations.Emblem.Reports.Impl
{
        ...
        : IEmblemSchemeReport
    {
        ...
        private EmblemSchemeReportImpl(EmblemId backgroundEmblemId, EmblemId foregroundEmblemId, EmblemId iconEmblemId)
        {
        ...
        public class Builder
        {
            ...
            public IEmblemSchemeReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new EmblemSchemeReportImpl(this.backgroundEmblemId, this.foregroundEmblemId, this.iconEmblemId);
                }
                else
                {
