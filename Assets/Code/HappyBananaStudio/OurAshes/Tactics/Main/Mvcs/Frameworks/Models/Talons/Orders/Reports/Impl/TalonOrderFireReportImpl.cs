namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Models.Talons.Orders.Reports.Impl
{
    ...
    /// Todo
    /// </summary>
    public struct TalonOrderFireReportImpl
        : ITalonOrderFireReport
    {
        ...
        private TalonOrderFireReportImpl(TalonCallSign actingTalonCallSign, TalonCallSign targetTalonCallSign,
        ...
        public class Builder
        {
            ...
            public ITalonOrderFireReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonOrderFireReportImpl(this.actingTalonCallSign,
