...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Attributes.Impl
{
    /// <summary>
    /// Todo
    /// </summary>
        ...
        public class Builder
        {
            ...
            private HashSet<string> IsInvalid()
            {
                ...
                if (this.bonusAttributesCollection == null)
                {
                    ...
                    {
                        argumentExceptionSet.Add("Collection: " + typeof(IBonusAttributes).Name + " has not been set");
                    }
                }
                else
                {
