...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Sorties.Games.Views.Canvases.Panels.Buttons.Constants
{
    /// <summary>
    ...
    {
        public static readonly int PANEL_SIZE_X = 2;
        public static readonly int PANEL_SIZE_Y = 5;
        public static readonly int PANEL_COORDs_X = 0;
        public static readonly int PANEL_COORDS_Y = 0;
        public static readonly int BUTTON_PANEL_X = 2;
