...
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.SplashScreens.Views.Canvases.Panels.Impls;
using System.Collections.Generic;
using System.Numerics;

namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.SplashScreens.Views.Canvases.Impls
{
    /// <summary>
        ...
        public override void InitialBuild()
        {
            ...
            List<ICanvasWidget> canvasWidgets = new List<ICanvasWidget>
            {
                ...
                ContinuePanelImpl.Builder.Get()
                    ...
                    .SetEnabled(true)
                    .SetName(this.mvcType + ":Continue:" + CanvasWidgetType.Panel)
                    .SetParent(this)
                    .Build(),
            };
