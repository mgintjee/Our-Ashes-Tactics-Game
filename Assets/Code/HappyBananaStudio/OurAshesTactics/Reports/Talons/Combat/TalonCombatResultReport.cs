...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Reports.Talons.Combat
{
    /// <summary>
    /// Todo
    /// </summary>
    public struct TalonCombatResultReport
        : ITalonCombatResultReport
    {
        ...
        /// </param>
        public TalonCombatResultReport(bool isTargetDestroyed, ITalonCombatOrderReport talonCombatOrderReport,
        ...
        public class Builder
        {
            ...
            public ITalonCombatResultReport Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonCombatResultReport(this.isTargetDestroyed, this.talonCombatOrderReport,
                        this.weaponResultReportList);
                }
                else
                {
