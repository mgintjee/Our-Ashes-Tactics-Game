...
using Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Menus.Homes.Frames.Requests.Inters;
using System;
using System.Collections.Generic;

namespace Assets.Code.Com.Hbs.OurAshes.Tactics.Main.Mvcs.Menus.Homes.Frames.Requests.Impls
{
    /// <summary>
    /// Home Request Interface
    /// </summary>
    public class HomeRequest
        : AbstractReport, IMvcControlHomeRequest
    {
        // Todo
        ...
        public class Builder
        {
            ...
            public interface IBuilder
                : IBuilder<IMvcControlHomeRequest>
            {
            ...
            private class InternalBuilder
                : AbstractBuilder<IMvcControlHomeRequest>, IBuilder
            {
