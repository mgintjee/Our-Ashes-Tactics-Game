...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.QSorties.Views.Canvases.Panels.Details.Factions.Constants
{
    ...
    public class PanelConstants
    {
        ...
        public static readonly float INFO_SIZE_X = DetailsPanelConstants.Factions.Vectors.SIZE.X / 4;
        ...
        public class PhalanxList
        {
            public static readonly float COORDS_Y = DetailsPanelConstants.Factions.Vectors.SIZE.Y - 3;
            public static readonly float COORDS_X = 0;
            public static readonly float SIZE_X = DetailsPanelConstants.Factions.Vectors.SIZE.Y;
            public static readonly float SIZE_Y = 1;
            public static readonly Vector2 COORDS = new Vector2(COORDS_X, COORDS_Y);
            public static readonly Vector2 SIZE = new Vector2(SIZE_X, SIZE_Y);
        }
