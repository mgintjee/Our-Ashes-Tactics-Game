...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Common.Coordinates
{
    public static class CubeCoordinatesCommonUtil
    {
        ...
        {
            return GetCubeCoordinatesDistanceFrom(cubeCoordinates, new CubeCoordinatesImpl(0, 0, 0));
        }
        ...
        public static ICubeCoordinates GetNegatedCubeCoordinates(ICubeCoordinates cubeCoordinates)
        {
            ...
            {
                return new CubeCoordinatesImpl(-1 * cubeCoordinates.GetX(), -1 * cubeCoordinates.GetY(), -1 * cubeCoordinates.GetZ());
            }
            else
            {
        ...
        public static HashSet<ICubeCoordinates> GetPossibleNeighborCubeCoordinatesSet(ICubeCoordinates cubeCoordinates)
        {
            ...
            {
                new CubeCoordinatesImpl(cubeCoordinates.GetX() + 1, cubeCoordinates.GetY(), cubeCoordinates.GetZ() - 1),
                new CubeCoordinatesImpl(cubeCoordinates.GetX() + 1, cubeCoordinates.GetY() - 1, cubeCoordinates.GetZ()),
                new CubeCoordinatesImpl(cubeCoordinates.GetX(), cubeCoordinates.GetY() + 1, cubeCoordinates.GetZ()-1),
                new CubeCoordinatesImpl(cubeCoordinates.GetX(), cubeCoordinates.GetY() - 1, cubeCoordinates.GetZ() + 1),
                new CubeCoordinatesImpl(cubeCoordinates.GetX() - 1, cubeCoordinates.GetY(), cubeCoordinates.GetZ() + 1),
                new CubeCoordinatesImpl(cubeCoordinates.GetX() - 1, cubeCoordinates.GetY() + 1, cubeCoordinates.GetZ()),
            }; ;
