    ...
    : Comparer<MechObject>
{
    ...
    {
        // Check if MechBoject A is null or has a null MechBehavior
        if (mechObjectA == null ||
            mechObjectA.GetMechBehavior() == null)
        {
            return 1;
        }
        // Check if MechBoject B is null or has a null MechBehavior
        else if (mechObjectB == null ||
            mechObjectB.GetMechBehavior() == null)
        {
            return -1;
        }
        else
