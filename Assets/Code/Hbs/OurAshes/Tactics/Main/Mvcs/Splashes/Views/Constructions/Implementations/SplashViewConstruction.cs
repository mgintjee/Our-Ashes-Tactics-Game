...
using Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Views.Constructions.Interfaces;
using System.Collections.Generic;

namespace Assets.Code.Hbs.OurAshes.Tactics.Main.Mvcs.Splashes.Views.Constructions.Implementations
{
    /// <summary>
