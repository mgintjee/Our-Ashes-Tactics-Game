...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Attributes.Impl.Talons
{
        ...
        : ITalonAttributes
    {
        ...
        /// </param>
        private TalonAttributes(IDestructibleAttributes destructableAttributes,
        ...
        public class Builder
        {
            ...
            public ITalonAttributes Build()
            {
                ...
                if (invalidReasons.Count == 0)
                {
                    ...
                    return new TalonAttributes(this.destructibleAttributes, this.fireableAttributes,
