...
namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Sorties.Menus.Views.Canvases.Panels.Details.Factions.PopUps
{
    /// <summary>
    /// Phalanx ID Minus PopUp Impl
    /// </summary>
    public class PhalanxIDMinusPopUpImpl
        : AbstractDynamicEnumPopUp<PhalanxID>
    {
        ...
        {
            return RequestType.FactionPhalanxIDMinusSelect + ":" + factionID.ToString() + ":" + id.ToString() + ":Button";
        }
        ...
        public class Builder
        {
                ...
                : PanelWidgetBuilders.InternalPanelWidgetBuilder, IInternalBuilder
            {
                ...
                {
                    PhalanxIDMinusPopUpImpl widget = gameObject.AddComponent<PhalanxIDMinusPopUpImpl>();
