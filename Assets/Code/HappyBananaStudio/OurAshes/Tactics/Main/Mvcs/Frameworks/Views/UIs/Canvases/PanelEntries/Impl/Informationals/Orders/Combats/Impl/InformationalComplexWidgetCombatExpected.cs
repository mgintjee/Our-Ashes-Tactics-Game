 ...
 * namespace Assets.Code.HappyBananaStudio.OurAshes.Tactics.Main.Mvcs.Frameworks.Views.UIs.Canvases.PanelEntries.Impl.Informationals.Orders.Combats.Impl
{
    ...
    /// Todo
    /// </summary>
    public class InformationalComplexWidgetCombatExpected
        : AbstractInformationalComplexWidgetCombat
    {
        ...
        public class Builder
        {
            ...
            public IComplexWidgetInformational Build()
            {
                ...
                {
                    InformationalComplexWidgetCombatExpected informationalComplexWidget =
                        new GameObject(typeof(InformationalComplexWidgetCombatExpected).Name)
                        .AddComponent<InformationalComplexWidgetCombatExpected>();
