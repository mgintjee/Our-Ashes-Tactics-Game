...
namespace Assets.Code.HappyBananaStudio.OurAshesTactics.Impl.Cameras
{
    public static class CameraPositionUtil
    {
        ...
        internal static Vector3 DetermineRotationVector(float zVal, float xVal)
        {
            ...
            {
                throw ArgumentExceptionUtil.Build("Unable to ?. Invalid Parameters. zVal=?, xVal",
                    new StackFrame().GetMethod().Name, zVal, xVal);
            }
