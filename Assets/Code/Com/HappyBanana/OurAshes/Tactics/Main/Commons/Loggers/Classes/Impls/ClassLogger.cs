...
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Loggers.Consoles.Impls;
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Loggers.Consoles.Inters;
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Loggers.Constants;
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Loggers.Files.Inters;
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Utils.Strings;
using Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Mvcs.Commons.Frames.Types;
using System;

namespace Assets.Code.Com.HappyBanana.OurAshes.Tactics.Main.Commons.Loggers.Classes.Impls
{
    /// <summary>
    /// Todo
    /// </summary>
